(library
  ...
  (define (uninstall . fields) (apply object fields))
  ...
  (define (uninstall/command argv . fields) (apply object (field 'argv argv) fields))
  ...
  (define (host/uninstall-command predicate-value argv . fields)
    (apply uninstall/command argv (field 'when predicate-value) fields))
  ...
  (define (uninstall/path path . fields) (apply object (field 'path path) fields))
  ...
  (define (host/uninstall-path predicate-value path . fields)
    (apply uninstall/path path (field 'when predicate-value) fields))
