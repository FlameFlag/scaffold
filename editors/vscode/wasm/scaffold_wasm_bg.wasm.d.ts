...
export const searchReferenceEntriesScaffoldScheme: (a: number, b: number, c: number, d: number) => void;
export const searchReferenceEntriesScaffoldSchemeForWorkspace: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
...
export const suggestReferenceEntriesScaffoldScheme: (a: number, b: number, c: number, d: number) => void;
export const suggestReferenceEntriesScaffoldSchemeForWorkspace: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
...
export const format_tables: (a: number, b: number, c: number) => void;
